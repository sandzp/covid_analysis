...
```{r warning=FALSE, message=FALSE}
ggpairs(data = df, columns = c(4,25:31))
```
...
```{r warning=FALSE, message=FALSE}
ggpairs(data = df, columns = c(4,44:49))
``` 
