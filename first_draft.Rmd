...
![](covid_skeptics.png){width=300px}
...
![](healthcare_infrastructure.png){width=300px}
...
![](travel_restrictions.png){width=300px}
...
![](average_temperature.png){width=300px}
...
![](percentage_republicans.png){width=300px}
