...
**The time limit for your slide presentation is 10 minutes.**  We will budget a few extra minutes for questions after you are done. We'd like to emphasize that this is an *incredibly* limited amount of time to present. The materials that you present should reflect these serious constraints! 
...
2. There should be at least one, and not more than two, slides that describe the one or two most important variables that you're using in your models. These slides should cover the important features of the variables that you're using: how are they are measured, the unit of observation, and why these *particular* variables are appropriate to use to answer your research question. (3 minutes) 
